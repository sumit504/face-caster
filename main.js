...
function renderApp() {
    ...
    if (state.currentView === 'profile') {
        ...
        document.getElementById('root').innerHTML = `
            <div class="app-container">
                <header class="header">
                    <h1><img src="https://face-caster.vercel.app/logo.png" alt="Logo" class="header-logo-inline"> Face Caster</h1>
                    <p>Decentralized real face onchain social network. Connect with your friends and share moments. Connect with your friends and share moments. Connect with your friends and share moments. Connect with your friends and share moments.</p>
                </header>
    ...
    document.getElementById('root').innerHTML = `
        <div class="app-container">
            <header class="header">
                <h1><img src="https://face-caster.vercel.app/logo.png" alt="Logo" class="header-logo-inline"> Face Caster</h1>
                <p>Decentralized real face onchain social network. Connect with your friends and share moments. Connect with your friends and share moments. Connect with your friends and share moments.</p>
